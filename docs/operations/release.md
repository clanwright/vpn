...
from a reviewed candidate with a clean worktree and complete the local
[verification gate](verify.md). Confirm that the changelog describes the final
surface, the version is an exact SemVer tag, and consumer integration has been
evaluated against the candidate revision.
