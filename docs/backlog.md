...
в бэклог. Mieru реализован в этой ветке на stock 3.36.0 по решению 12 сентября 2026;
остальные протоколы **запланированы для отдельного обсуждения и внедрения**.
Release и активация сервисов не входят в согласованный объём.
Исследование upstream — 8 сентября, уточнение Mieru — 12 сентября 2026.
